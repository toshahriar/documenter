...
export function DocumentEdit({ data, onSubmit, onClose }: any) {
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-4">
      ...
      <div>
        <div className="flex justify-between items-center mt-4 mb-4">
          ...
          <div
            className="flex items-center bg-black text-white py-1 px-2 cursor-pointer rounded-md"
            onClick={() =>
      ...
      <div className="flex justify-end mt-4 space-x-4">
        ...
        <Button
          type="submit"
          className="w-1/5 bg-black text-white py-2 rounded-md hover:bg-gray-800"
        >
          {loading ? (
            <>
